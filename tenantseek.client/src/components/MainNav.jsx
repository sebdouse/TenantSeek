...
function MainNav() {
    return (
        ...
        <nav className="fixed top-4 z-50 flex w-[97%] justify-around gap-5 rounded-2xl border-2 border-[#5927E5] bg-[#7844E5] py-5 shadow">
        ...
        {/*<div name="sticky-navbar-interceptor" className=" overlay"/>*/}
        </>
    );
}
